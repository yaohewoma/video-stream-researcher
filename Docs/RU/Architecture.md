...
Исследователь видеопотоков использует современную архитектурную модель MVVM (Model-View-ViewModel), сочетающую внедрение зависимостей и принципы разделения интерфейсов для достижения четкой организации кода и хорошей поддерживаемости. Проект основан на .NET 10.0 и фреймворке Avalonia UI, поддерживая кроссплатформенное выполнение.
